//! conduit-proto — the single shared request/response stream contract.
//!
...
//! (`conduit-h1`, `conduit-h2`, `conduit-h3`) maps wire format to this type;
//! `conduit-lifecycle` reads from and writes back to this type.
//!
